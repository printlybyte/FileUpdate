...
public class MyAdapter extends BaseAdapter
{
  ...
  public MyAdapter(Context context,List<String> it,List<String> pa)
  {
    ...
    mIcon3 = BitmapFactory.decodeResource(context.getResources(),R.drawable.bxfile_file_dir);  //把folder变成了
  ...
  public View getView(int position,View convertView,ViewGroup parent)
  {
    ...
    if(convertView == null)
    {
      convertView = mInflater.inflate(R.layout.file_row2, null);  //R.layout.file_row
