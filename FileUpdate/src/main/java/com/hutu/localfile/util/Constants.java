...
public class Constants {
	...
	// 文件下载目录
	public static final String FILE_BASEPATH = Environment.getExternalStorageDirectory() + "/hutu/";// 基本目录
	...
	public  static   int    itemUnmUnupdate;
	public  static   int    itemUnmUnupding;
	public  static   int    itemUnmUnuped;
}
