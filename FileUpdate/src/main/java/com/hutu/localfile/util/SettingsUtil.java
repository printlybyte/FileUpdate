...
public class SettingsUtil {
    ...
    public static void write(Context ctx, String key,
            String value) {
    ...
    public static boolean read(Context ctx, String key,
            boolean defValue) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(ctx);
    ...
    public static long read(Context ctx, String key,
            long defValue) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(ctx);
    ...
    public static boolean isMounted(Context context, String path) {
        ...
        if (file.exists() || file.mkdir() || file.isDirectory()) return true;
        return false;
    }
...
//            L.d("Manifest_IMEI: " + imei + ", Phone_IMEI:" + imeiStr);
            if (!TextUtils.isEmpty(imei) && imei.equals(imeiStr)) return true;
